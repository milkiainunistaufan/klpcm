...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><a href="/dashboard/klpcmbpjs" class="btn btn-warning">Kembali</a></h1>
    <div class="btn-toolbar mb-2 mb-md-0">
    </div>
  </div>
  <div class="col-lg-7">
      <form action="/dashboard/klpcmbpjs" method="post">
        @csrf
          <div class=" row">
                ...
                <div class="col-sm-10 mb-3">
                    <select class="form-select form-select-sm" name="dpjp_id" aria-label="Small select example">
                        @foreach ($dpjps as $dpjp)
                            <option value="{{ $dpjp->id }}">{{ $dpjp->dokter }}</option>
                        @endforeach
                    </select>
                </div>
